...
# 🔒 NexusHR Modular Backend Setup Guide

NexusHR now uses a clean **MVC (Model-View-Controller)** architecture to ensure scalability, maintainability, and security.
...
3.  **Install Dependencies**:
    ```bash
    cd server
    npm install express mysql2 dotenv multer cors nodemailer
    ```
...
### Add new column
alter table nexushr_db.leaves add column ccEmail VARCHAR(255);